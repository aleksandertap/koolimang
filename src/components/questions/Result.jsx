      ...
      <div>
        ...
        <p>
          ...
          {winner.id === 8 ? (
            ...
            <a href={`https://voco.ee/kool/${winner.name.toLowerCase().replace(/ /g, "-").replace(/ä/g, "a")}` } target="_blank" rel="noopener noreferrer">
              Tutvu kindlasti kooli lehel{" "}
              {winner.id === 2 ? winner.name.replace("K", "k") : winner.name.toLowerCase().replace(/ /g, "-")}i
              erialadega!
            </a>
          )}
        </p>
